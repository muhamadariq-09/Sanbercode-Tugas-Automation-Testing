...
class TestLogin(unittest.TestCase): 
    ...
    def test_a_success_login(self): 
        ...
        time.sleep(3)
        browser.find_element(By.XPATH,"/html/body/div/div[2]/form/input[1]").send_keys("ariqaja@email.com") # isi email
        time.sleep(1)
        browser.find_element(By.CSS_SELECTOR,"input#password").send_keys("ariqaja123") # isi password
        time.sleep(1)
    ...
    def test_a_wrong_password(self): 
        ...
        browser.find_element(By.XPATH,"/html/body/div/div[2]/form/input[1]").send_keys("ariqaja@email.com") # isi email
        time.sleep(1)
        browser.find_element(By.CSS_SELECTOR,"input#password").send_keys("ariqganteng456") # isi password
        time.sleep(1)
        browser.find_element(By.ID,"signin_login").click() # klik tombol sign in
        time.sleep(1)
